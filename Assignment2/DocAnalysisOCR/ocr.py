...
from preprocess import unify_image
...
# segments every letter and predicts the the letter of each with the saved trained CNN and returns the gt from the xml as well

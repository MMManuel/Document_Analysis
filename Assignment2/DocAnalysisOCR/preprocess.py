...
# padds the image to preserve the aspect ration and resizes the image in the specified size
def unify_image(im, size):
...
# crops the black background of the thresholded image to only preserve the content
